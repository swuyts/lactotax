...
welcome_text <-
  ...
  <p>In the past, several species of the genus <i>Lactobacillus</i> had already been placed in new genera, such as <i>Atopobium, Carnobacterium, Eggerthia, Kandleria, Lactococcus, Leuconostoc</i> or <i>Weissella</i>. However, the newly used whole genome-based comparisons suggested the need for a much more profound taxonomic reorganisation, resulting in the ion of 23 new genera and reduction the original genus of <i>Lactobacillus</i> to only 38 species around the type species, <i>Lactobacillus delbrueckii</i>. Further details can be found here (IJSEM) and here (UNIBO). </p>
